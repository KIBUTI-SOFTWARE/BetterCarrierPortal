...
<body>
    <div class="tinker md:bg-black/[0.15] dark:bg-transparent relative py-5 px-5 md:py-0 sm:px-8 md:px-0 after:content-[''] after:bg-gradient-to-b after:from-theme-1 after:to-theme-2 dark:after:from-darkmode-800 dark:after:to-darkmode-800 after:fixed after:bg-primary after:inset-0 after:z-[-2]">
        <!-- BEGIN: Mobile Menu -->
        ...
        <div class="mt-[4.7rem] flex overflow-hidden md:mt-0">
            ...
            <nav class="side-nav z-10 hidden overflow-x-hidden px-5 pb-16 md:block md:w-[100px] xl:w-[250px]">
                ...
                <ul>
                    ...
                    ?>
                        <li>
                            <a href="/view-job-posts" class="side-menu <?php if ($_SERVER["REQUEST_URI"] === "employment-posts" || $_SERVER["REQUEST_URI"] === "internship-posts" || str_contains($_SERVER["REQUEST_URI"], "post")) {
                                                                        ?>side-menu--active<?php
                                                                                        }
                                                                                            ?>">
                                <div class="side-menu__icon">
                        ...
                        <div data-transition="" data-selector=".show" data-enter="transition-all ease-linear duration-150"
                            ...
                            <div data-tw-merge=""
                                ...
                                <div class="p-2 font-medium font-normal">
                                    <div class="font-medium"><?= $user['user_firstname'] . " " . $user['user_lastname'] ?></div>
